...
<%-- 		
		<script>
			function ChangeValueYear() {
				year = document.getElementById('year').options[year.selectedIndex].value;
				/* return year; */
			};
			
			function ChangeValueSem() {
				semester = document.getElementById('semester').options[year.selectedIndex].value;
				/* return semester; */
			};
		</script>
		...
		<form method="post">
		<tr>
			<select id="year" style="font-size:20px; width:50px;" onchange="ChangeValueYear()">
